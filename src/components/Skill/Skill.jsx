...
const Skill = ({directionLeft, img,status}) => {
  ...
  return (
    <div className='group relative flex cursor-pointer'>
        ...
        />
        <div className='absolute opacity-0 group-hover:opacity-60 transition duration-300 ease-in-out group-hover:bg-white w-[50px] h-[50px] md:h-28 md:w-28 xl:h-32 xl:w-32 rounded-full z-0'>
